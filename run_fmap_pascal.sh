...
dino_save_path="data-tss/TSS_CVPR2016/PASCAL_feat_token_11_NOMASK"
sd_save_path="data-tss/TSS_CVPR2016/PASCAL_sd"
fmap_save_path="data-tss/TSS_CVPR2016/PASCAL_fmap"
fmap_save_path_2="data-tss/TSS_CVPR2016/PASCAL_fmap_2"


python preprocess.py --dataset_name PASCAL \
    --root_dir_path data-tss/.s/TSS_CVPR2016/PASCAL \
    --facet token \
    --layer 11 \
    --save_path data-tss/TSS_CVPR2016/PASCAL_feat_token_11_NOMASK \
    --root_path data-tss/.s/TSS_CVPR2016/ 

echo "Done extracting DINO features"

python tss_sd.py --dataset PASCAL\
                --root_dir_path data-tss/.s/TSS_CVPR2016/PASCAL \
                --save_path data-tss/TSS_CVPR2016/PASCAL_sd 
